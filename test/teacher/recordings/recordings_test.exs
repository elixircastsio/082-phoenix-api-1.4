defmodule Teacher.RecordingsTest do
  ...
  describe "albums" do
    ...
    @valid_attrs %{artist: "some artist", summary: "some summary", title: "some title", year: "some year"}
    @update_attrs %{artist: "some updated artist", summary: "some updated summary", title: "some updated title", year: "some updated year"}
